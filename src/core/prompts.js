...
export function buildSystemPrompt({ app, agent, thread, tools }) {
  ...
  lines.push('', '## Your computers',
    ...
    ...(otherPcs.length
      ...
      : herePc ? [] : ['No computer of theirs is linked to Holly Bot yet: they can run Holly Computer on their PC or Mac (on Windows, the Holly Computer app installs it) and sign in on the page it opens (the computer button at the top right of the app shows how).']),
