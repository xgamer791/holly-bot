...
export const Icon = {
  ...
  pause: I(html`<rect x="6" y="5" width="3.5" height="14" rx="1" /><rect x="14.5" y="5" width="3.5" height="14" rx="1" />`, { fill: 'currentColor' }),
  backspace: I(html`<path d="M9 5h10a2 2 0 012 2v10a2 2 0 01-2 2H9l-6-7z" /><path d="M12.5 9.5l5 5M17.5 9.5l-5 5" />`),
