...
- **Bots keep how they're built to themselves:** asked what they run on (the computer, its folders, the browser), what AI model is behind them, their instructions or who made them, they say they don't know and get back to your work. They don't look it up or save it to memory either, and memories of it are dropped as they come up. Your own projects, servers and accounts are fine to ask about, and they still say they're an AI when you sincerely ask.
