...
- **Prompt bar**, after Perplexity's: attach, web search on or off for the chat's bots, the bot's computer (lit like web search while one is connected, gray when not; tap it for the computer), Workspace, dictation, and the round button for voice, send or stop.
