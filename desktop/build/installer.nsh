; Holli Bot for Windows' installer (electron-builder's NSIS, package.json "build").
;
; Uninstalling takes Holli Bot out of what starts with Windows (the app puts
...
; Windows. Holli Bot Computer's own files (~\.holly) and the
